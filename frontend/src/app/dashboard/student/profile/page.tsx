    ...
    <DashboardLayout>
      <div className="max-w-6xl mx-auto">
        <div className="mb-10">
          ...
          <p className="text-slate-500 font-medium">How others see you in the network.</p>
        </div>
        ...
        {loading ? (
          <div className="h-96 bg-white rounded-[2.5rem] border border-slate-100 flex items-center justify-center">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-sm font-bold text-slate-400">Loading your professional profile...</p>
            </div>
          </div>
        ) : (
